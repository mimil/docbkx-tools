...
/**
 * An <code>EntityResolver</code> that will inject a couple of additional general internal
...
public class InjectingEntityResolver implements EntityResolver {
  ...
  /**
   * A boolean to keep track of the fact if the entities already have been injected.
   */
  private boolean injected;

  /**
   * The String representation of the type of conversion made. Used to populate the
   * docbkx.type entity.
   */
  private String type;
  ...
  /**
   * Returns the <code>InputSource</code> containing the external entity's data. This
   * implementation will normally return an <code>InputSource</code> that contains all additional
   * entities defined, including a reference to the <code>InputSource</code> that was originally
  ...
  /**
   * The <code>InputSource</code> that will replace the first <code>InputSource</code>
  ...
  public class ReplacementInputSource extends InputSource {
    /**
     * The system identifier of the <code>InputSource</code> that should be retrieved right
     * after this one.
     */
